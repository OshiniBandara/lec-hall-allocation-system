...
function LecturerLogin() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const docSnapshot = await getDoc(doc(buddhi, "lecturer", employeeNumber));
    ...
    <div>
      <div className="admin-signup-container">
        ...
        <form className="signup-form" onSubmit={handleSubmit}>
          ...
          <p style={{ textAlign: 'center', marginTop: '20px' }}>Don't have an account? <a href="/LecturerSign">Sign Up</a></p>
      ...
      {showSuccessMessage && (
        <div className="success-message-container">
          <div className="white-box success-message-box">
            ...
            <a href="/HomeLec" className="ok-button">OK</a>
          </div>
        </div>
      )}
      {showErrorMessage && (
